...
namespace Techmate.DataModel
{
    ...
    {
        private const string _url = @"https://gdata.youtube.com/feeds/api/users/TechBreakItalia/uploads?start-index=1&max-results=20&v=2";

        public static async Task<IEnumerable<Techbreak>> LoadDataAsync()
        {
            try
            {
    ...
    public class YouTubeDataProvider
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<Techbreak>> Load()
        {
